      ...
      <section className="hero-section">
        ...
        <div className="description-section">
          ...
          <p className="hero-text">
            ...
            misión cumplida. <br/>Descubrí espacios con alma, viví donde querés
            estar.
          </p>
          <div className="hero-buttons-container">
            <Button text={"Busqueda propiedad"} icon={ArrowWhiteButton} className="btn-green hero-btn"/>
            <Button text={"Contactanos"} icon={ArrowBlackButton} className="btn-gold hero-btn"/>
          </div>
        </div>
      </section>
